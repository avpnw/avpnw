...
<div class="section-container accordion" data-section="accordion">
  ...
  <section>
    ...
    <section>
    <p class="title" data-section-title><a href="#section3">периодичность обследования на сифилис и бактериоскопического исследования на заболевания, передающиеся половым путем, так как в Приказе не указана необходимость проведения бактериоскопического исследования на заболевания, передающиеся половым путем, однако в перечне противопоказаний для работы такие заболевания имеются.</a></p>
